 ...
 * @author Preetinder
 * 
 * @version 1.0	2018-03-23 It is a JavaFX-based GUI implementation of the merge and analysis tool.
 * 
 */
...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	public UserInterface(Pane theRoot) {
		...
		setupLabelUI(lable_Tile, "Arial", 24, LoginForm1.WINDOW_WIDTH, Pos.CENTER, 0, 10);
		
		// Label the text field of the source directory just above it, left aligned
		setupLabelUI(lable_SourceDirectory, "Arial", 14, LoginForm1.WINDOW_WIDTH, Pos.BASELINE_LEFT, 10, 80);
		...
		setupButtonUI(button_ReportGenrate, "Symbol", 20, 20, Pos.BASELINE_LEFT, 10, LoginForm1.WINDOW_HEIGHT-50);
		...
		setupButtonUI(button_Quit, "Symbol", 20, 20, Pos.BASELINE_LEFT, LoginForm1.WINDOW_WIDTH -75, LoginForm1.WINDOW_HEIGHT- 50);
